...
import pytesseract
import numpy as np
pytesseract.pytesseract.tesseract_cmd = r'C:\Program Files\tesseract-ocr-w64-setup-5.3.0.20221222.exe'
...
extract_num('"C:\Users\user\PycharmProjects\Numberplate\test_images\test1.jpeg"')
